...
private CryptoUtil(){}
public static String md5Hash(String source, String salt, int iter) {
 ...
 * @return
 */	
public static String simpleHash(String algorithmName, String source, String salt, int hashIterations) {
...
public static void main(String[] args) {
	...
	String sha512Hash = CryptoUtil.sha512Hash("top@988988", salt, 8192);
	System.out.println("salt: "+salt+" sha512Hash passwd: "+sha512Hash+" len: "+sha512Hash.length());
    String md5  = new Md5Hash("top@958958",salt,2048).toHex();
