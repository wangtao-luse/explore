--初始化用户组
insert into T_M_GROUP(Group_NAME,Group_PARENT,GROUP_NOTE,CREATE_AT)
values('系统用户','-1','系统管理者使用','1669857258752');
insert into T_M_GROUP(Group_NAME,Group_PARENT,GROUP_NOTE,CREATE_AT)
values('个人用户','-1','个人用户使用','1669857258752');
insert into T_M_GROUP(Group_NAME,Group_PARENT,GROUP_NOTE,CREATE_AT)
values('企业用户','-1','企业用户使用','1669857258752');
--初始化管理员账号
...
--初始化角色表
insert into T_m_ROLE(ROLE_NAME,ROLE_NOTE,ROLE_PARENT,CREATE_AT)
values('系统管理员','系统管理员使用','-1','1669855946978');
insert into T_m_ROLE(ROLE_NAME,ROLE_NOTE,ROLE_PARENT,CREATE_AT)
values('个人','个人使用','-1','1669855946978');
insert into T_m_ROLE(ROLE_NAME,ROLE_NOTE,ROLE_PARENT,CREATE_AT)
values('企业','企业使用','-1','1669855946978');